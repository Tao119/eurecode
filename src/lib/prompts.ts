...
【クイズ数の決定基準 - 重要】
コードの複雑さと「なぜ？」質問の作りやすさで適切な質問数を決定:

**質問数は無理に3問にしない。適切な質問が作れる数だけにする。**

- **1問**: シンプルな処理、または「なぜ？」質問が1つしか作れない場合
- **2問**: 中程度のコード、2つの重要なポイントがある場合
- **3問**: 複雑なロジックで、3つ以上の重要な設計判断がある場合のみ

**判断基準:**
- コード内で「なぜこうしたか？」と問える具体的なポイントを数える
- 抽象的な質問しか思いつかない場合は、質問数を減らす
- 質を優先：2問の良い質問 > 3問の微妙な質問
